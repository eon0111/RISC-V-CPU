...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/eon/tmp/mux4/test_run_dir/Mux4_should_generate_the_right_output_given_any_valid_selector_value_as_input/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_i1 = u; break;
      case 2 : dut->io_i2 = u; break;
      case 3 : dut->io_i3 = u; break;
      case 4 : dut->io_i4 = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_i1; break;
      case 2 : value = dut->io_i2; break;
      case 3 : value = dut->io_i3; break;
      case 4 : value = dut->io_i4; break;
      case 5 : value = dut->io_o; break;
      case 6 : value = dut->io_sel; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/eon/tmp/mux4/test_run_dir/Mux4_should_generate_the_right_output_given_any_valid_selector_value_as_input/Mux4.vcd)";
