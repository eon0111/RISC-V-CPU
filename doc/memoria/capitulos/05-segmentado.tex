...
\begin{lstlisting}[style=scalaStyleNoNumbering,columns=fullflexible]
...
\caption{Comparación entre la implementación original y la implementación adaptada del módulo \texttt{InstructionFetch}.}
\label{tab:instructionfetch-comparison}
