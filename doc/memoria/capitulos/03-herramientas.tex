...
\begin{minipage}[c]{0.48\textwidth}
\centering
\raisebox{0.12\height}{\includegraphics[width=0.8\linewidth]{res/img/diagramas/cap03mux4/mux4.png}}
\end{minipage}
