...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/eon/RISC-V-CPU/ca2023-lab3/test_run_dir/Hazard_Unit_should_solve_control_hazards_thus_flushing_FD_if_branches_are_not_taken/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/eon/RISC-V-CPU/ca2023-lab3/test_run_dir/Hazard_Unit_should_solve_control_hazards_thus_flushing_FD_if_branches_are_not_taken/HazardUnit.vcd)";
