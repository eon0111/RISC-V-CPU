...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/eon/tfm/RISC-V-CPU/ca2023-lab3/test_run_dir/InstructionFetch_of_Single_Cycle_CPU_should_fetch_instruction/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/eon/tfm/RISC-V-CPU/ca2023-lab3/test_run_dir/InstructionFetch_of_Single_Cycle_CPU_should_fetch_instruction/InstructionFetch.)";
