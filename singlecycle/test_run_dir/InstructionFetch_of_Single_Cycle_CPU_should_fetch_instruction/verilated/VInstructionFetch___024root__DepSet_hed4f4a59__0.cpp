...
bool VInstructionFetch___024root___eval_phase__ico(VInstructionFetch___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VInstructionFetch__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VInstructionFetch___024root___eval_phase__ico\n"); );
    // Init
...
VL_INLINE_OPT void VInstructionFetch___024root___nba_sequent__TOP__0(VInstructionFetch___024root* vlSelf) {
    ...
    // Body
    if (vlSelf->reset) {
        vlSelf->InstructionFetch__DOT__pc = 0x1000U;
...
bool VInstructionFetch___024root___eval_phase__act(VInstructionFetch___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VInstructionFetch__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VInstructionFetch___024root___eval_phase__act\n"); );
    // Init
...
bool VInstructionFetch___024root___eval_phase__nba(VInstructionFetch___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VInstructionFetch__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VInstructionFetch___024root___eval_phase__nba\n"); );
    // Init
...
void VInstructionFetch___024root___eval(VInstructionFetch___024root* vlSelf) {
    ...
    while (__VicoContinue) {
        ...
        __VicoContinue = 0U;
        if (VInstructionFetch___024root___eval_phase__ico(vlSelf)) {
            __VicoContinue = 1U;
        }
    ...
    while (__VnbaContinue) {
        ...
        while (vlSelf->__VactContinue) {
            ...
            if (VInstructionFetch___024root___eval_phase__act(vlSelf)) {
                vlSelf->__VactContinue = 1U;
            }
        }
        if (VInstructionFetch___024root___eval_phase__nba(vlSelf)) {
            __VnbaContinue = 1U;
        }
    }
}
