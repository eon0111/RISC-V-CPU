...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/eon/tfm/02-ca2024-lab3-pipelined/test_run_dir/Pipelined_CPU_should_store_a_value_in_memory/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/eon/tfm/02-ca2024-lab3-pipelined/test_run_dir/Pipelined_CPU_should_store_a_value_in_memory/TestTopModule.vcd)";
