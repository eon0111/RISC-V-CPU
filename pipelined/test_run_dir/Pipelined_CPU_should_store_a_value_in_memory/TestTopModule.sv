...
`endif // RANDOMIZE_GARBAGE_ASSIGN
  reg [31:0] mem [0:122]; // @[src/main/scala/peripheral/InstructionROM.scala 26:45]
  wire  mem_io_data_MPORT_en; // @[src/main/scala/peripheral/InstructionROM.scala 26:45]
  wire [6:0] mem_io_data_MPORT_addr; // @[src/main/scala/peripheral/InstructionROM.scala 26:45]
  ...
  `else
  assign mem_io_data_MPORT_data = mem_io_data_MPORT_addr >= 7'h7b ? _RAND_0[31:0] : mem[mem_io_data_MPORT_addr]; // @[src/main/scala/peripheral/InstructionROM.scala 26:45]
  `endif // RANDOMIZE_GARBAGE_ASSIGN
...
`endif // SYNTHESIS
initial begin
  $readmemh("/home/eon/tfm/02-ca2024-lab3-pipelined/verilog/simple.asmbin.txt", mem);
end
endmodule
module ROMLoader(
  input         clock,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  _GEN_0 = address == 32'h7a | valid; // @[src/main/scala/peripheral/ROMLoader.scala 33:40 34:13 21:24]
  wire [34:0] _GEN_3 = address <= 32'h7a ? _io_bundle_address_T_2 : 35'h0; // @[src/main/scala/peripheral/ROMLoader.scala 24:26 27:37 30:28]
  assign io_bundle_address = _GEN_3[31:0];
  assign io_bundle_write_data = address <= 32'h7a ? io_rom_data : 32'h0; // @[src/main/scala/peripheral/ROMLoader.scala 25:26 27:37 29:28]
  assign io_bundle_write_enable = address <= 32'h7a; // @[src/main/scala/peripheral/ROMLoader.scala 27:16]
  assign io_bundle_write_strobe_0 = address <= 32'h7a; // @[src/main/scala/peripheral/ROMLoader.scala 27:16]
  assign io_bundle_write_strobe_1 = address <= 32'h7a; // @[src/main/scala/peripheral/ROMLoader.scala 27:16]
  assign io_bundle_write_strobe_2 = address <= 32'h7a; // @[src/main/scala/peripheral/ROMLoader.scala 27:16]
  assign io_bundle_write_strobe_3 = address <= 32'h7a; // @[src/main/scala/peripheral/ROMLoader.scala 27:16]
  ...
  always @(posedge clock) begin
    ...
    end else if (address <= 32'h7a) begin // @[src/main/scala/peripheral/ROMLoader.scala 27:37]
