...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/eon/RISC-V-CPU/ca2023-lab3/test_run_dir/Hazard_Unit_should_detect_RAW_hazards_involving_instructions_in_the_execute_memory_and_writeback_phases/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_rs1_ex = u; break;
      case 2 : dut->io_rs2_ex = u; break;
      case 3 : dut->io_rd_mem = u; break;
      case 4 : dut->io_rd_wb = u; break;
      case 5 : dut->io_reg_wr_enable_mem = u; break;
      case 6 : dut->io_reg_wr_enable_wb = u; break;
      case 7 : dut->io_rs1_d = u; break;
      case 8 : dut->io_rs2_d = u; break;
      case 9 : dut->io_rd_ex = u; break;
      case 10 : dut->io_ex_regs_write_src = u; break;
      case 11 : dut->io_ex_jump_flag = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_rs1_ex; break;
      case 2 : value = dut->io_rs2_ex; break;
      case 3 : value = dut->io_rd_mem; break;
      case 4 : value = dut->io_rd_wb; break;
      case 5 : value = dut->io_reg_wr_enable_mem; break;
      case 6 : value = dut->io_reg_wr_enable_wb; break;
      case 7 : value = dut->io_rs1_d; break;
      case 8 : value = dut->io_rs2_d; break;
      case 9 : value = dut->io_rd_ex; break;
      case 10 : value = dut->io_ex_regs_write_src; break;
      case 11 : value = dut->io_ex_jump_flag; break;
      case 12 : value = dut->io_alu_rs1_src; break;
      case 13 : value = dut->io_alu_rs2_src; break;
      case 14 : value = dut->io_pc_stall; break;
      case 15 : value = dut->io_srFD_stall; break;
      case 16 : value = dut->io_srDE_flush; break;
      case 17 : value = dut->io_srFD_flush; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/eon/RISC-V-CPU/ca2023-lab3/test_run_dir/Hazard_Unit_should_detect_RAW_hazards_involving_instructions_in_the_execute_memory_and_writeback_phases/HazardUnit.vcd)";
