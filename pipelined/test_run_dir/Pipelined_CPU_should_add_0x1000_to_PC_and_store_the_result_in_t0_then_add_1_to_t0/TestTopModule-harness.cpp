...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/eon/tfm/02-ca2024-lab3-pipelined/test_run_dir/Pipelined_CPU_should_add_0x1000_to_PC_and_store_the_result_in_t0_then_add_1_to_t0/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 5 : value = dut->io_instruction_valid; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/eon/tfm/02-ca2024-lab3-pipelined/test_run_dir/Pipelined_CPU_should_add_0x1000_to_PC_and_store_the_result_in_t0_then_add_1_to_t0/TestTopModule.vcd)";
