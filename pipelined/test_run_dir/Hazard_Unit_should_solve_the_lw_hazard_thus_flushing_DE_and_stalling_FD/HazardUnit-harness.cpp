...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/eon/RISC-V-CPU/ca2023-lab3/test_run_dir/Hazard_Unit_should_solve_the_lw_hazard_thus_flushing_DE_and_stalling_FD/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/eon/RISC-V-CPU/ca2023-lab3/test_run_dir/Hazard_Unit_should_solve_the_lw_hazard_thus_flushing_DE_and_stalling_FD/HazardUnit.vcd)";
