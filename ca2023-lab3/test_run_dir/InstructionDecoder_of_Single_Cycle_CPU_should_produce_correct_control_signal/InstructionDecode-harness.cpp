...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/home/eon/Documentos/TFM/RISC-V-CPU/ca2023-lab3/test_run_dir/InstructionDecoder_of_Single_Cycle_CPU_should_produce_correct_control_signal/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/home/eon/Documentos/TFM/RISC-V-CPU/ca2023-lab3/test_run_dir/InstructionDecoder_of_Single_Cycle_CPU_should_produce_correct_control_signal/InstructionDecode.)";
